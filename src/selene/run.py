...
parse_configs_and_run(load_path("./src/selene/config_nopoolTT1.yml"), lr=lr)
parse_configs_and_run(load_path("./src/selene/config_nopoolTT2.yml"), lr=lr)
parse_configs_and_run(load_path("./src/selene/config_nopoolTT4.yml"), lr=lr)
parse_configs_and_run(load_path("./src/selene/config_nopoolTT8.yml"), lr=lr)
parse_configs_and_run(load_path("./src/selene/config_nopoolTT16.yml"), lr=lr)
